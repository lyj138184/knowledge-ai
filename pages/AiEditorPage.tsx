...
export const AiEditorPage: React.FC = () => {
  ...
  const handleInput = (e: React.FormEvent<HTMLDivElement>) => {
    ...
    // but here we might need it for syncing. For this demo, we use ref for reading mostly.
    ...
    <div className="flex flex-col h-full bg-background-light dark:bg-background-dark overflow-hidden font-display relative">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="relative flex flex-1 flex-col overflow-hidden bg-background-light dark:bg-background-dark">
          {/* Editor Toolbar */}
          <div className="flex h-12 items-center justify-between border-b border-border-light bg-surface-light px-4 shadow-sm z-[5] shrink-0 dark:bg-surface-dark dark:border-border-dark select-none">
            <div className="flex items-center gap-1 overflow-x-auto text-text-secondary scrollbar-hide">
              ...
              <div className="h-4 w-px bg-border-light mx-2 dark:bg-border-dark"></div>
              <button onMouseDown={(e) => {e.preventDefault(); execCommand('insertUnorderedList');}} className="rounded p-1.5 hover:bg-gray-100 hover:text-text-main dark:hover:bg-gray-800 dark:hover:text-white" title="List"><span className="material-symbols-outlined text-[20px]">format_list_bulleted</span></button>
          ...
          <div className="flex-1 overflow-y-auto p-4 md:p-8 relative bg-background-light dark:bg-background-dark custom-scrollbar" id="editor-container">
            <div className="mx-auto max-w-[850px] min-h-[900px] rounded-xl bg-surface-light p-16 shadow-sm border border-border-light dark:bg-surface-dark dark:border-border-dark relative">
              ...
              {slashMenu?.show && (
                <div 
                  className="fixed z-50 w-80 overflow-hidden rounded-xl border border-border-light bg-surface-light shadow-2xl dark:bg-surface-dark dark:border-border-dark ring-1 ring-black/5 animate-in fade-in zoom-in-95 duration-150"
              ...
              {selectionMenu?.show && (
                <div 
                  className="fixed z-50 flex flex-col items-center animate-in fade-in zoom-in-95 duration-150 transform -translate-x-1/2"
              ...
              {isAiGenerating && (
                <div className="absolute top-4 right-4 flex items-center gap-2 bg-surface-light dark:bg-surface-dark shadow-lg rounded-full px-3 py-1.5 border border-border-light dark:border-border-dark animate-pulse">
